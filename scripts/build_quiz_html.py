...
SECTIONS = [
    ...
    ("00-46-11_Командний-рядок-Файли-та-директорії.txt", "00:46:11", "Файли та директорії"),
    ("01-00-25_git-Вступ.txt", "01:00:25", "git — Вступ"),
    ("01-07-24_git-Налаштування.txt", "01:07:24", "git — Налаштування"),
    ...
    ("02-33-31_git-Вступ-git-branch.txt", "02:33:31", "git — Вступ у branch"),
    ("02-44-52_git-Практика-git-branch.txt", "02:44:52", "git — Практика branch"),
    ...
    ("04-44-23_github-Push-локального-репозиторію.txt", "04:44:23", "github — Push"),
...
<head>
  ...
  <title>Git & GitHub Quiz — Повний курс</title>
  <style>
    :root {
      --bg: #0d1117; --panel: #161b22; --border: #30363d; --text: #e6edf3;
      --muted: #8b949e; --green: #3fb950; --cyan: #39c5cf; --yellow: #d29922;
      --orange: #f0883e; --blue: #58a6ff; --purple: #a371f7; --red: #f85149;
      --font: "SF Mono", Menlo, Consolas, monospace;
    }
    * { box-sizing: border-box; }
    body {
      margin: 0; min-height: 100vh;
      background: radial-gradient(1200px 600px at 10% -10%, #2d1f14 0%, var(--bg) 55%);
    ...
    .sec-list li.active { background: #21262d; color: var(--orange); }
...
<body>
  <div class="wrap">
    ...
    <header>
      ...
      <p>
        29 розділів курсу <a href="https://youtu.be/9CnZihyYjjA" target="_blank" rel="noopener">Nikita Tymoshenko</a>.
        Питання з GIFT-файлів — обери розділ зліва або режим «Всі».
      </p>
    </header>
    <div class="layout">
      <aside class="sidebar">
